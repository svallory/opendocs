...
|---------|--------|------|-------------|
| 0.2.0 | RFC Draft | Current | Added FQN IDs, repository info, source locations, and relations model |
| 0.1.0 | RFC Draft | 2024 | Initial specification based on DocItem model |
...
- **Tooling Enabled**: Language-native IDs, repository links, and source locations enable rich IDE integration and cross-referencing
...
<Note>
  **Version 0.2.0 Updates**: This version introduces key features for tooling integration:
  - **Language-native FQN IDs**: Use each language's natural naming convention (e.g., `package#Symbol`, `crate::module::Type`)
  - **Repository information**: Link documentation to source code with customizable URL templates
  - **Source locations**: Precise file paths, line numbers, and columns for "View Source" features
  - **Relations model**: Flexible relationship system supporting extends, implements, and language-specific relationships
</Note>
